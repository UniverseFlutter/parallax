...
import 'package:parallax/parallax_container.dart';
  ...
  Widget build(BuildContext context) {
    return PageView(
      ...
      children: [
        ParallaxContainer(
          index: '0',
          // THIS IS USED TO GIVE THE NAME OF THE IMAGE Eg. 1.jpg
          offset: widget.offset,
          i: 0.0,
          // THIS IS TO PROVIDE THE INDEX FOR THE PARALLAX EFFECT START AND STOP SO THAT ITS SCROLLS PERFECTLY WHEN IT APPEEARS ON THE SCREEN
          text: 'Apex Legends',
        ),
        ParallaxContainer(
          index: '1',
